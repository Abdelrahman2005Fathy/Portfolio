...
export const projects = [
  ...
  },
  {
    ...
    link: "https://abdelrahman2005fathy.github.io/Github-Search-Repo/",
  },
  {
    id: 3,
    ...
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/next.svg"],
    link: "https://kanban-delta-gold.vercel.app/",
  },
  {
    id: 4,
    title: "Weather App",
...
export const testimonials = [
  {
      quote:
        "Working with Abdelrahman was an incredible experience. His attention to detail and creative approach brought our ideas to life seamlessly. Abdelrahman not only delivered exceptional results but also exceeded our expectations. Highly recommended for anyone looking to make their website truly impactful.",
      name: "Sarah Thompson",
  ...
  {
      quote:
        "Abdelrahman's expertise transformed our online presence. His innovative solutions and commitment to perfection made our project a huge success. From design to development, Abdelrahman handled every aspect with precision and professionalism. We’re thrilled with the results!",
      name: "James Carter",
    ...
    {
      quote:
        "Abdelrahman was a game-changer for our brand. His ability to understand our needs and translate them into a stunning and functional website was remarkable. His dedication and technical expertise make him a standout developer. We couldn’t have asked for a better partner.",
      name: "Emily Davis",
      title: "Marketing Manager at Horizon Creatives",
    },
    {
      quote:
        "Abdelrahman brought our vision to life with unparalleled skill and creativity. His strategic approach to web development ensured our site was not only visually appealing but also user-friendly. A true professional who delivers beyond expectations!",
      name: "David Miller",
      title: "CTO of WaveLink Solutions",
  },
  {
      quote:
        "From start to finish, Abdelrahman demonstrated exceptional dedication and talent. His technical knowledge and design sensibilities perfectly aligned with our goals, resulting in a website that truly reflects our brand. I highly recommend him to anyone seeking excellence in development.",
      name: "Olivia Harris",
